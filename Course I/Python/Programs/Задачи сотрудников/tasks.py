...
# base = {('Flyme', 'qwerty'): ['Flyme', 'qwerty', '12345', 'admin', [(0, 'Сделать Дз'), (0, 'Вынести мусор')]], ('Ivan', 'qwertu'): ['Ivan', 'qwertu', '12345', 'user', [(0, 'Выучить историю'), (1, 'Приготовиться к худшему')]]}
