...
namespace ConsoleApplication2
{
    struct Point
    {
        ...
        public Point(int _x, int _y)  // конструктор.
        {
            x = _x; y = _y;
        }
    }
    ...
    class Прямоугольник
    {
        ...
        //-----------------------------------------------------------------------------------
        public Прямоугольник(Point _p1, Point _p2)  // конструктор 1.
        {
            count++;
        ...
        //-----------------------------------------------------------------------------------
        public Прямоугольник(Point _p1, int _w, int _h)     // конструктор 2.
        {
            count = count + 1;
            p1 = _p1;
            w = _w;   h = _h;
            p2.x = p1.x + w; p2.y = p1.y + h;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            прямоугольник1 = new Прямоугольник(new Point(10, 5), new Point(40, 30));

            Прямоугольник квадрат1 = new Прямоугольник(new Point(40, 20), 30, 30);
            ...
            прямоугольник1.P2 = new Point(15, 10);
            прямоугольник1.W = 80;
            ...
            try
            {
                прямоугольник2 = new Прямоугольник(new Point(80, 90), new Point(40, 30));
